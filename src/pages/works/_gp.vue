    ...
    <div class="l-works-container">
      ...
      <div class="l-works-main">
        <div class="works__contents">
          ...
          <div class="works__section">
            <h2 class="works__section-title">やったこと① サイトリニューアル</h2>
          ...
          <div class="works__section">
            ...
            <p>下記の新機能・新サービス・サービス改定などの仕様の策定などのディレクションを行った。</p>
          ...
          <div class="works__section">
            ...
            <p>外注クリエイターへのテンプレートの新規デザインディレクション、テンプレート作成時に使用できるカラーの刷新などを行った。</p>
            <p>
              <span class="works__section-label">Before</span>
            ...
            <p>
              <span class="works__section-label">After</span>
              サービスのコンセプトにそぐうデザインを作成できるクリエイターを探すところからスタート。<br>
              ユーザーの属性などを</p>
